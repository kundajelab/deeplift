...
**This version of DeepLIFT has been tested with Keras 2.2.0 & tensorflow 1.10.1**. See the tags for older versions, and see [this FAQ question](https://github.com/kundajelab/deeplift#my-model-architecture-is-not-supported-by-this-deeplift-implementation-what-should-i-do) for information on other implementations of DeepLIFT that may work with different versions of tensorflow.
