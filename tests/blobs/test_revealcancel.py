...
class TestActivations(unittest.TestCase):
    ...
    def set_up_prediction_func_and_deeplift_func(self, dense_mxts_mode,
                                                       out_layer):
    ...
    def test_relu_deeplift(self): 
        ...
        fprop_results, bprop_results_each_task =\
            self.set_up_prediction_func_and_deeplift_func(
             dense_mxts_mode=DenseMxtsMode.RevealCancelRedist,
             out_layer=out_layer) 
